...
{
    public sealed class ObjectReferencesCacheOld
    {
        private readonly bool _canCacheAnything;
        private readonly IDictionary<object, object> _cache;
        private static readonly object dummy = new();

        private ObjectReferencesCacheOld(bool canCacheAnything , object self, object cloned)
        {
        ...
        private ObjectReferencesCacheOld(bool canCacheAnything)
        {
            _canCacheAnything = canCacheAnything;
            _cache = canCacheAnything
        ...
        public static ObjectReferencesCacheOld Default { get; } =
            new ObjectReferencesCacheOld(false);
        ...
        public static ObjectReferencesCacheOld Create(bool canCacheAnything, object self, object cloned) =>
            new(canCacheAnything, self, cloned);

        public static ObjectReferencesCacheOld Create(bool canCacheAnything) =>
